...
class DemoServiceTest {
    ...
    @Mock
    private Resource loadHolidayFile;
    ...
    void setup() throws URISyntaxException, IOException {
        ...
        URI uri = new URI("file:/Users/donchan922/Documents/next-holiday/out/production/resources/syukujitsu.csv");
        when(loadHolidayFile.getURI()).thenReturn(uri);
    }
